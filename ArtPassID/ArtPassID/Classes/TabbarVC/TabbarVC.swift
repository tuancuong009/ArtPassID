...
class TabbarVC: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        self.tabBar.items?[0].title = "iPass ID".uppercased()
       ...
       self.tabBar.items?[3].image = tab4UnSelect
        ...
        //
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.font : UIFont(name: "Gilmer-Regular", size: 12) as Any, NSAttributedString.Key.foregroundColor: UIColor.white], for: .normal)
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.font : UIFont(name: "Gilmer-Regular", size: 12) as Any, NSAttributedString.Key.foregroundColor: Common.hexStringToUIColor("6c63ff")], for: .selected)
