...
//        self.tabBar.items?[2].title = "Dealrooms".uppercased()
       ...
       self.tabBar.items?[2].selectedImage = tab4Select
       self.tabBar.items?[2].image = tab4UnSelect
        self.tabBar.items?[2].title = "Profile".uppercased()
        //self.tabBar.items?[2].badgeValue = "2"
        //self.tabBar.items?[2].badgeColor = Common.hexStringToUIColor("8B1A4B")
        // Do any additional setup after loading the view.
        //
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.font : UIFont(name: "NunitoSans-SemiBold", size: 13) as Any, NSAttributedString.Key.foregroundColor: UIColor.white], for: .normal)
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.font : UIFont(name: "NunitoSans-SemiBold", size: 13) as Any, NSAttributedString.Key.foregroundColor: Common.hexStringToUIColor("6c63ff")], for: .selected)
